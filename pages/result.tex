...
\input{./extras/liquefaction_table}
\end{table}
\pagebreak
...
\input{./extras/methods_summary_table}
\end{table}
\pagebreak

\section{Correlation and regression between methods}
\input{./extras/methods_relation_table}